...
Input: { DB 1 , DB 2 , . . . , DBn } , initial W ( 1 ) , W ( 2 ) ; iterationmax , Learning rate η
...
Algorithm 5 Transformation of BCP ciphertexts under pk 1 , pk 2 , · · · , pk n to FHE ciphertexts under pk F
