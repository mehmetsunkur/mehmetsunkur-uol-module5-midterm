...
pip3 install --user -r .devcontainer/requirements.txt --extra-index-url http://host.docker.internal:9191/index --trusted-host host.docker.internal
...
apt-get clean
# pip3 install poetry llm docling --extra-index-url http://host.docker.internal:9191/index --trusted-host host.docker.internal
